...
class BoulderWettbewerbe extends React.Component {
  render() {
...
export default BoulderWettbewerbe

export const pageQuery = graphql`
  query BoulderWettbewerbe {
  
  allContentfulBlogPost(filter: {category: {contentful_id: {eq:"3z2NRGvZO86844Miqc6CSc"} } },
